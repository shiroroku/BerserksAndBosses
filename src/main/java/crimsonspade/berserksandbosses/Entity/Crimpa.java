...
public class Crimpa extends Monster {
    public Crimpa(EntityType<? extends Crimpa> p_32889_, Level p_32890_) {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, Warpa.class, false, false));
