...
public class Blizzpa extends Monster {
    public Blizzpa(EntityType<? extends Blizzpa> p_32889_, Level p_32890_) {
    ...
    public SoundEvent getAmbientSound() {
        return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("berserksandbosses:blizzpa_ambience"));
    }
