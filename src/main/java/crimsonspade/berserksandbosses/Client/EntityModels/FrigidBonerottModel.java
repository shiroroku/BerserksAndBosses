...
public class FrigidBonerottModel<T extends FrigidBonerott> extends EntityModel<T> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            new ResourceLocation(BerserksAndBosses.MODID, "frigidbonerott"), "main");
    ...
    public FrigidBonerottModel(ModelPart root) {
